...
export class Solid {
    ...
    /**
     * Import one retained B-rep body from STEP bytes.
     *
     * Unlike `importStepBuffer`, this returns a live `Solid`, so callers can
     * transform, measure, boolean, tessellate, and export the imported body.
    ...
    /**
     * Create a solid by sweeping a profile along connected line and arc segments.
     * @param {string} profile_json
     ...
     * @param {number | null | undefined} frame_mode
     * @param {Float64Array} up_direction
     * @param {Float64Array} guide_points
     * @param {number | null} [continuity_mode]
     * @param {number | null} [tangent_tolerance_degrees]
     * @returns {Solid}
     */
    static sweepComposite(profile_json, segments_json, twist_angle, scale_start, scale_end, path_segments, arc_segments, orientation, scale_stations_json, profile_stations_json, frame_mode, up_direction, guide_points, continuity_mode, tangent_tolerance_degrees) {
        const ptr0 = passStringToWasm0(profile_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(segments_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        var ptr2 = isLikeNone(scale_stations_json) ? 0 : passStringToWasm0(scale_stations_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len2 = WASM_VECTOR_LEN;
        var ptr3 = isLikeNone(profile_stations_json) ? 0 : passStringToWasm0(profile_stations_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len3 = WASM_VECTOR_LEN;
        const ptr4 = passArrayF64ToWasm0(up_direction, wasm.__wbindgen_malloc);
        const len4 = WASM_VECTOR_LEN;
        const ptr5 = passArrayF64ToWasm0(guide_points, wasm.__wbindgen_malloc);
        const len5 = WASM_VECTOR_LEN;
        const ret = wasm.solid_sweepComposite(ptr0, len0, ptr1, len1, !isLikeNone(twist_angle), isLikeNone(twist_angle) ? 0 : twist_angle, !isLikeNone(scale_start), isLikeNone(scale_start) ? 0 : scale_start, !isLikeNone(scale_end), isLikeNone(scale_end) ? 0 : scale_end, isLikeNone(path_segments) ? 0x100000001 : (path_segments) >>> 0, isLikeNone(arc_segments) ? 0x100000001 : (arc_segments) >>> 0, !isLikeNone(orientation), isLikeNone(orientation) ? 0 : orientation, ptr2, len2, ptr3, len3, isLikeNone(frame_mode) ? 0x100000001 : (frame_mode) >>> 0, ptr4, len4, ptr5, len5, isLikeNone(continuity_mode) ? 0x100000001 : (continuity_mode) >>> 0, !isLikeNone(tangent_tolerance_degrees), isLikeNone(tangent_tolerance_degrees) ? 0 : tangent_tolerance_degrees);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Solid.__wrap(ret[0]);
     ...
     * @returns {Solid}
     */
    static sweepHelix(profile_json, radius, pitch, height, turns, twist_angle, scale_start, scale_end, path_segments, arc_segments, orientation, scale_stations_json, profile_stations_json, frame_mode, up_direction, guide_points) {
        const ptr0 = passStringToWasm0(profile_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        var ptr1 = isLikeNone(scale_stations_json) ? 0 : passStringToWasm0(scale_stations_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len1 = WASM_VECTOR_LEN;
        var ptr2 = isLikeNone(profile_stations_json) ? 0 : passStringToWasm0(profile_stations_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len2 = WASM_VECTOR_LEN;
        const ptr3 = passArrayF64ToWasm0(up_direction, wasm.__wbindgen_malloc);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passArrayF64ToWasm0(guide_points, wasm.__wbindgen_malloc);
        const len4 = WASM_VECTOR_LEN;
        const ret = wasm.solid_sweepHelix(ptr0, len0, radius, pitch, height, turns, !isLikeNone(twist_angle), isLikeNone(twist_angle) ? 0 : twist_angle, !isLikeNone(scale_start), isLikeNone(scale_start) ? 0 : scale_start, !isLikeNone(scale_end), isLikeNone(scale_end) ? 0 : scale_end, isLikeNone(path_segments) ? 0x100000001 : (path_segments) >>> 0, isLikeNone(arc_segments) ? 0x100000001 : (arc_segments) >>> 0, !isLikeNone(orientation), isLikeNone(orientation) ? 0 : orientation, ptr1, len1, ptr2, len2, isLikeNone(frame_mode) ? 0x100000001 : (frame_mode) >>> 0, ptr3, len3, ptr4, len4);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Solid.__wrap(ret[0]);
     ...
     * @returns {Solid}
     */
    static sweepLine(profile_json, start, end, twist_angle, scale_start, scale_end, orientation, scale_stations_json, profile_stations_json, frame_mode, up_direction, guide_points) {
        const ptr0 = passStringToWasm0(profile_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        ...
        const ptr5 = passArrayF64ToWasm0(up_direction, wasm.__wbindgen_malloc);
        const len5 = WASM_VECTOR_LEN;
        const ptr6 = passArrayF64ToWasm0(guide_points, wasm.__wbindgen_malloc);
        const len6 = WASM_VECTOR_LEN;
        const ret = wasm.solid_sweepLine(ptr0, len0, ptr1, len1, ptr2, len2, !isLikeNone(twist_angle), isLikeNone(twist_angle) ? 0 : twist_angle, !isLikeNone(scale_start), isLikeNone(scale_start) ? 0 : scale_start, !isLikeNone(scale_end), isLikeNone(scale_end) ? 0 : scale_end, !isLikeNone(orientation), isLikeNone(orientation) ? 0 : orientation, ptr3, len3, ptr4, len4, isLikeNone(frame_mode) ? 0x100000001 : (frame_mode) >>> 0, ptr5, len5, ptr6, len6);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Solid.__wrap(ret[0]);
    ...
    /**
     * Create a solid by sweeping a profile through a smooth Catmull-Rom guide path.
     *
     * `points` is a flat `[x0,y0,z0,...]` array with at least two distinct points.
     * @param {string} profile_json
     ...
     * @returns {Solid}
     */
    static sweepSpline(profile_json, points, twist_angle, scale_start, scale_end, path_segments, arc_segments, orientation, scale_stations_json, profile_stations_json, frame_mode, up_direction, guide_points, start_tangent, end_tangent) {
        const ptr0 = passStringToWasm0(profile_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        ...
        const ret = wasm.solid_sweepSpline(ptr0, len0, ptr1, len1, !isLikeNone(twist_angle), isLikeNone(twist_angle) ? 0 : twist_angle, !isLikeNone(scale_start), isLikeNone(scale_start) ? 0 : scale_start, !isLikeNone(scale_end), isLikeNone(scale_end) ? 0 : scale_end, isLikeNone(path_segments) ? 0x100000001 : (path_segments) >>> 0, isLikeNone(arc_segments) ? 0x100000001 : (arc_segments) >>> 0, !isLikeNone(orientation), isLikeNone(orientation) ? 0 : orientation, ptr2, len2, ptr3, len3, isLikeNone(frame_mode) ? 0x100000001 : (frame_mode) >>> 0, ptr4, len4, ptr5, len5, ptr6, len6, ptr7, len7);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Solid.__wrap(ret[0]);
...
/**
 * Reopen STEP bytes and report exact imported-BRep metrics as JSON.
 *
 * This is intentionally separate from [`import_step_buffer`], whose coarse
 * tessellation is optimized for interactive preview rather than validation.
 * @param {Uint8Array} data
 * @returns {string}
 */
 ...
 * @param {string | null} [scale_stations_json]
 * @param {string | null} [profile_stations_json]
 * @returns {Solid}
 */
export function op_sweep_helix(profile_json, radius, pitch, height, turns, twist_angle, scale_start, scale_end, path_segments, arc_segments, orientation, scale_stations_json, profile_stations_json) {
    const ptr0 = passStringToWasm0(profile_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(scale_stations_json) ? 0 : passStringToWasm0(scale_stations_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
    var ptr2 = isLikeNone(profile_stations_json) ? 0 : passStringToWasm0(profile_stations_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len2 = WASM_VECTOR_LEN;
    const ret = wasm.op_sweep_helix(ptr0, len0, radius, pitch, height, turns, !isLikeNone(twist_angle), isLikeNone(twist_angle) ? 0 : twist_angle, !isLikeNone(scale_start), isLikeNone(scale_start) ? 0 : scale_start, !isLikeNone(scale_end), isLikeNone(scale_end) ? 0 : scale_end, isLikeNone(path_segments) ? 0x100000001 : (path_segments) >>> 0, isLikeNone(arc_segments) ? 0x100000001 : (arc_segments) >>> 0, !isLikeNone(orientation), isLikeNone(orientation) ? 0 : orientation, ptr1, len1, ptr2, len2);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return Solid.__wrap(ret[0]);
 ...
 * @returns {Solid}
 */
export function op_sweep_line(profile_json, start, end, twist_angle, scale_start, scale_end, orientation, scale_stations_json, profile_stations_json) {
    const ptr0 = passStringToWasm0(profile_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArrayF64ToWasm0(start, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    ...
    var ptr4 = isLikeNone(profile_stations_json) ? 0 : passStringToWasm0(profile_stations_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len4 = WASM_VECTOR_LEN;
    const ret = wasm.op_sweep_line(ptr0, len0, ptr1, len1, ptr2, len2, !isLikeNone(twist_angle), isLikeNone(twist_angle) ? 0 : twist_angle, !isLikeNone(scale_start), isLikeNone(scale_start) ? 0 : scale_start, !isLikeNone(scale_end), isLikeNone(scale_end) ? 0 : scale_end, !isLikeNone(orientation), isLikeNone(orientation) ? 0 : orientation, ptr3, len3, ptr4, len4);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return Solid.__wrap(ret[0]);
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_b5d9e2fb389fef91: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return wasm_bindgen_76dec33ece36143c___convert__closures_____invoke___wasm_bindgen_76dec33ece36143c___JsValue__wasm_bindgen_76dec33ece36143c___JsValue_____(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { dtor_idx: 3655, function: Function { arguments: [NamedExternref("GPUUncapturedErrorEvent")], shim_idx: 3656, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm.wasm_bindgen_76dec33ece36143c___closure__destroy___dyn_core_9b3796e30d99ddb7___ops__function__FnMut__wgpu_4e0c31adc80bd3ad___backend__webgpu__webgpu_sys__gen_GpuUncapturedErrorEvent__GpuUncapturedErrorEvent____Output_______, wasm_bindgen_76dec33ece36143c___convert__closures_____invoke___wgpu_4e0c31adc80bd3ad___backend__webgpu__webgpu_sys__gen_GpuUncapturedErrorEvent__GpuUncapturedErrorEvent_____);
            return ret;
        },
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm.wasm_bindgen_76dec33ece36143c___closure__destroy___dyn_core_9b3796e30d99ddb7___ops__function__FnMut__wasm_bindgen_76dec33ece36143c___JsValue____Output_______, wasm_bindgen_76dec33ece36143c___convert__closures_____invoke___wasm_bindgen_76dec33ece36143c___JsValue_____);
            return ret;
        },
...
function wasm_bindgen_76dec33ece36143c___convert__closures_____invoke___wgpu_4e0c31adc80bd3ad___backend__webgpu__webgpu_sys__gen_GpuUncapturedErrorEvent__GpuUncapturedErrorEvent_____(arg0, arg1, arg2) {
    wasm.wasm_bindgen_76dec33ece36143c___convert__closures_____invoke___wgpu_4e0c31adc80bd3ad___backend__webgpu__webgpu_sys__gen_GpuUncapturedErrorEvent__GpuUncapturedErrorEvent_____(arg0, arg1, arg2);
}

function wasm_bindgen_76dec33ece36143c___convert__closures_____invoke___wasm_bindgen_76dec33ece36143c___JsValue_____(arg0, arg1, arg2) {
    wasm.wasm_bindgen_76dec33ece36143c___convert__closures_____invoke___wasm_bindgen_76dec33ece36143c___JsValue_____(arg0, arg1, arg2);
}

function wasm_bindgen_76dec33ece36143c___convert__closures_____invoke___wasm_bindgen_76dec33ece36143c___JsValue__wasm_bindgen_76dec33ece36143c___JsValue_____(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen_76dec33ece36143c___convert__closures_____invoke___wasm_bindgen_76dec33ece36143c___JsValue__wasm_bindgen_76dec33ece36143c___JsValue_____(arg0, arg1, arg2, arg3);
}
